...
#define DER 50.00 // initial derivative parameter
...
#define MAX_OT1 99 // Set output % for upper limit for OT1

#define MIN_OT2 0 // Set output % for lower limit for OT2.  0% power will always be available
#define MAX_OT2 99 // Set output % for upper limit for OT2
...
#define FAN_AUTO_COOL 99 // Set fan output duty for auto cool when using PID;STOP command
// cut power to Heater if fan duty is less than HTR_CUTOFF_FAN_VAL (to protect heater in air roaster). Set to 0 for no cutoff
